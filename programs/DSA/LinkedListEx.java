...
//more fast as compare to arraylist
//arralist work on index if one index remove then all list need to change its index but in linkedlist it will change only position
